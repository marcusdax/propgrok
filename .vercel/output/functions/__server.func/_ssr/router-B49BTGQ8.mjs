...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B49BTGQ8.js
var router_B49BTGQ8_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Dy6YqcWj.css";
var APP_NAME = "PropertyInsight";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Search any address, geofence a neighborhood, render photoreal exterior upgrades, and underwrite the parcel."
			},
			{
				name: "theme-color",
				content: "#0c0d0b"
...
var $$splitComponentImporter = () => import("./routes-COYYzdx0.mjs");
...
//#endregion
export { getRouter, router_B49BTGQ8_exports as t };
