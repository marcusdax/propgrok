...
import { i as SAMPLES, n as FEATURE_STYLES, t as FEATURES$1 } from "./knowledge-CO2vv4iv.js";
import { c as pct, i as formatMiles, n as cn, r as compactUsd, u as usd } from "./utils-BOIfZi7B.js";
import { t as buildDossier } from "./engine-CkvdWsoW.js";
import * as React from "react";
import { useEffect, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { z } from "zod";
import { AlertTriangle, Check, CheckCircle2, ChevronDown, Compass, FileSearch, Loader2, MapPin, Search, ShieldAlert } from "lucide-react";
...
//#region src/components/comparison-slider.tsx
function ComparisonSlider({ before, after, loading }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			before && after && /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsx("div", {
...
function SelectTrigger({ className, children, ...props }) {
	return /* @__PURE__ */ jsxs(SelectPrimitive.Trigger, {
		...
		children: [children, /* @__PURE__ */ jsx(SelectPrimitive.Icon, {
			asChild: true,
			children: /* @__PURE__ */ jsx(ChevronDown, { className: "size-4 text-muted-foreground" })
		})]
	});
}
...
//#endregion
//#region src/lib/property-store.ts
...
//#endregion
//#region src/lib/server/render.ts
var FEATURES = [
	"garage_door",
	"roof",
	"windows",
...
var composeRender = createServerFn({ method: "POST" }).validator((input) => ({
	...
	imageDataUrl: z.string().min(32).max(65e5).parse(input.imageDataUrl),
...
var composeCopy = createServerFn({ method: "POST" }).validator((input) => ({
	...
	address: input.address ? z.string().max(160).parse(input.address) : void 0,
...
//#endregion
//#region src/components/alter-studio.tsx
...
function AlterStudio() {
	...
	const [feature, setFeature] = useState("garage_door");
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Label, { children: "Feature" }), /* @__PURE__ */ jsxs(Select, {
						value: feature,
						onValueChange: (v) => onFeature(v),
						children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsx(SelectContent, { children: FEATURES$1.map((f) => /* @__PURE__ */ jsxs(SelectItem, {
							value: f.key,
							children: [
								f.label,
								" · ",
					...
					className: "space-y-1.5",
					children: [/* @__PURE__ */ jsx(Label, { children: "Style" }), /* @__PURE__ */ jsxs(Select, {
						value: style,
						onValueChange: setStyle,
						children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsx(SelectContent, { children: styles.map((s) => /* @__PURE__ */ jsx(SelectItem, {
							value: s.id,
							children: s.label
						}, s.id)) })]
					})]
			...
			/* @__PURE__ */ jsxs("div", {
				className: "space-y-1.5",
				children: [/* @__PURE__ */ jsx(Label, { children: "Direction (optional)" }), /* @__PURE__ */ jsx(Textarea, {
					rows: 2,
					value: notes,
			...
			(render?.headline || render?.error) && /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: render.error ? "Render note" : render.headline }) }), /* @__PURE__ */ jsx(CardContent, {
				className: "space-y-2 text-sm",
				children: render.error ? /* @__PURE__ */ jsx("p", {
					className: "text-destructive",
					children: render.error
				}) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("p", { children: render.body }), /* @__PURE__ */ jsx("p", {
					className: "text-muted-foreground",
					children: render.roiStatement
				})] })
			})] }),
			render?.afterDataUrl && /* @__PURE__ */ jsx(Button, {
				type: "button",
				variant: "outline",
...
function Slider({ className, ...props }) {
	return /* @__PURE__ */ jsxs(SliderPrimitive.Root, {
		...
		}), /* @__PURE__ */ jsx(SliderPrimitive.Thumb, { className: "block size-4 rounded-full border border-primary bg-foreground shadow-border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50" })]
	});
}
//#endregion
//#region src/lib/server/analyze.ts
...
var generateCampaign = createServerFn({ method: "POST" }).validator((input) => ({
	pins: z.array(z.any()).max(12).parse(input.pins),
...
var searchAddress = createServerFn({ method: "POST" }).validator((input) => {
	return { q: z.string().trim().min(2).max(180).parse(input.q) };
...
var fetchAmenities = createServerFn({ method: "POST" }).validator((input) => ({
	...
	radiusM: z.number().min(80).max(4e3).parse(input.radiusM)
...
//#endregion
//#region src/components/campaign-panel.tsx
function CampaignPanel() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Label, { children: ["Radius · ", formatMiles(radius)] }), /* @__PURE__ */ jsx("span", {
			...
			zoneHits.length > 0 && /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Harvest" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("ul", {
				className: "max-h-48 space-y-1 overflow-y-auto text-sm",
				children: zoneHits.map((h) => /* @__PURE__ */ jsxs("li", {
			...
			/* @__PURE__ */ jsxs("div", {
				className: "space-y-1.5",
				children: [/* @__PURE__ */ jsx(Label, { children: "Vertical" }), /* @__PURE__ */ jsxs(Select, {
					value: industry,
					onValueChange: setIndustry,
					children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsx(SelectContent, { children: FEATURES$1.map((f) => /* @__PURE__ */ jsx(SelectItem, {
						value: f.label,
						children: f.label
					}, f.key)) })]
				})]
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: campaign.map((p) => /* @__PURE__ */ jsxs("article", {
					className: "rounded-xl border border-border bg-card p-4",
					children: [
						/* @__PURE__ */ jsx("p", {
							className: "text-[11px] uppercase tracking-wider text-muted-foreground",
...
//#endregion
//#region src/components/command-search.tsx
function CommandSearch({ onSelect }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			loading ? /* @__PURE__ */ jsx(Loader2, { className: "absolute right-3 top-1/2 size-4 -translate-y-1/2 animate-spin text-muted-foreground" }) : /* @__PURE__ */ jsx("kbd", {
			...
			open && /* @__PURE__ */ jsx("div", {
				...
				children: hits.length > 0 ? /* @__PURE__ */ jsx("ul", {
					className: "max-h-72 overflow-y-auto py-1",
					children: hits.map((h) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
						type: "button",
						...
						children: [/* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 size-4 shrink-0 text-primary" }), /* @__PURE__ */ jsxs("span", {
							className: "min-w-0",
							children: [/* @__PURE__ */ jsx("span", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						children: SAMPLE_PINS.map((s) => /* @__PURE__ */ jsxs("button", {
							type: "button",
							...
							children: [/* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("span", {
								...
								children: s.blurb
							})] }), /* @__PURE__ */ jsx(Compass, { className: "size-3.5 text-muted-foreground" })]
						}, s.pin.id))
					})]
				})
			})
...
//#endregion
//#region src/components/dossier-panel.tsx
...
function DossierPanel({ dossier, loading, neighborhood, onSample }) {
	if (loading && !dossier) return /* @__PURE__ */ jsx(DossierSkeleton, {});
	if (!dossier) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: SAMPLE_PINS.map((s) => /* @__PURE__ */ jsx(Button, {
					type: "button",
					variant: "outline",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							dossier.enriched ? /* @__PURE__ */ jsx(Badge, {
								variant: "ok",
							...
							profile.occupancy !== "owner" && /* @__PURE__ */ jsx(Badge, {
								variant: "outline",
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Condition" }) }), /* @__PURE__ */ jsx(CardContent, {
				className: "space-y-3",
				children: condEntries.map(([k, v]) => /* @__PURE__ */ jsxs("div", {
					className: "space-y-1",
					children: [
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx(Progress, { value: v.score }),
						/* @__PURE__ */ jsx("p", {
							className: "text-xs text-muted-foreground",
							children: v.note
						})
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Renovation ROI matrix" }) }), /* @__PURE__ */ jsxs(CardContent, { children: [
				/* @__PURE__ */ jsx("div", {
					className: "mb-4 h-44",
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						}), /* @__PURE__ */ jsx("tbody", { children: plays.map((p) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsxs("span", { children: [p.rank, "."] }),
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Storm intelligence · Recon DPS" }) }), /* @__PURE__ */ jsxs(CardContent, {
				className: "space-y-3",
				children: [/* @__PURE__ */ jsx("p", {
					className: "text-sm",
					children: dps.action
				}), dps.factors.map((f) => /* @__PURE__ */ jsxs("div", {
					className: "space-y-1",
					children: [
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx(Progress, { value: f.points }),
						/* @__PURE__ */ jsx("p", {
							className: "text-xs text-muted-foreground",
							children: f.note
						})
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Metro path" }) }), /* @__PURE__ */ jsxs(CardContent, { children: [/* @__PURE__ */ jsx("div", {
				className: "h-40",
				children: /* @__PURE__ */ jsx(ResponsiveContainer, {
					width: "100%",
					height: "100%",
			...
			/* @__PURE__ */ jsxs("div", {
				className: "grid gap-3 sm:grid-cols-2",
				children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Investor fit" }) }), /* @__PURE__ */ jsx(CardContent, {
					className: "space-y-3",
					children: dossier.investorFit.map((f) => /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex justify-between text-sm",
							children: [/* @__PURE__ */ jsx("span", { children: f.strategy }), /* @__PURE__ */ jsx("span", {
				...
				})] }), /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Demographics" }) }), /* @__PURE__ */ jsx(CardContent, {
					className: "grid grid-cols-2 gap-3",
					children: dossier.demographics.map((d) => /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx("p", {
							className: "text-[11px] uppercase tracking-wider text-muted-foreground",
							children: d.label
						}),
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Risks" }) }), /* @__PURE__ */ jsx(CardContent, {
				className: "space-y-3",
				children: dossier.risks.map((r) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Incentives" }) }), /* @__PURE__ */ jsx(CardContent, {
				className: "space-y-3",
				children: dossier.incentives.map((i) => /* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx("p", {
							className: "text-sm",
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Underwriting narrative" }) }), /* @__PURE__ */ jsxs(CardContent, {
				className: "space-y-3 text-sm leading-relaxed",
				children: [
					/* @__PURE__ */ jsx("p", { children: dossier.narrative }),
					/* @__PURE__ */ jsx("p", {
						className: "text-muted-foreground",
						children: dossier.occupancyNote
					}),
					neighborhood && /* @__PURE__ */ jsxs(Fragment, { children: [
						/* @__PURE__ */ jsx(Separator, {}),
						/* @__PURE__ */ jsx("p", { children: neighborhood.summary }),
						/* @__PURE__ */ jsx("p", {
							className: "text-muted-foreground",
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Evidence chain" }) }), /* @__PURE__ */ jsxs(CardContent, {
				...
				children: [
					...
					dossier.evidence.sources.map((s) => /* @__PURE__ */ jsxs("p", { children: [
						s.sourceType,
						" · ",
						s.sourceId,
						" · ",
					...
					dossier.evidence.assertions.map((a) => /* @__PURE__ */ jsxs("p", { children: [
						a.type,
						": ",
						a.value,
						" — ",
...
function DossierSkeleton() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "grid grid-cols-2 gap-2 sm:grid-cols-4",
				children: Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-20" }, i))
			}),
...
function NeighborhoodPanel({ intel, loading }) {
	if (loading && !intel) return /* @__PURE__ */ jsxs("div", {
		className: "space-y-3",
		children: [/* @__PURE__ */ jsx(Skeleton, { className: "h-24" }), /* @__PURE__ */ jsx(Skeleton, { className: "h-40" })]
	});
	if (!intel) return /* @__PURE__ */ jsx("p", {
		className: "text-sm text-muted-foreground",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: intel.clusters.map((c) => /* @__PURE__ */ jsxs("div", {
					className: "rounded-lg border border-border bg-card p-3",
					children: [/* @__PURE__ */ jsx("p", {
						className: "text-[11px] uppercase tracking-wider text-muted-foreground",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, {
					...
					className: "space-y-2 text-sm",
					children: [intel.schoolHighlights.length > 0 ? intel.schoolHighlights.map((school) => /* @__PURE__ */ jsxs("div", {
					...
					}, `${school.name}-${school.kind}`)) : /* @__PURE__ */ jsx("p", {
						className: "text-muted-foreground",
					...
					className: "space-y-2 text-sm",
					children: intel.amenityHighlights.length > 0 ? intel.amenityHighlights.map((amenity) => /* @__PURE__ */ jsxs("div", {
						className: "flex items-start justify-between gap-3",
						children: [/* @__PURE__ */ jsxs("span", {
							className: "min-w-0",
							children: [/* @__PURE__ */ jsx("span", {
					...
					}, amenity.id)) : /* @__PURE__ */ jsx("p", {
						className: "text-muted-foreground",
						children: "No nearby amenity highlights returned."
					})
				})] })]
			}),
			intel.census && /* @__PURE__ */ jsxs(Card, {
				className: "border-primary/25",
				children: [/* @__PURE__ */ jsx(CardHeader, {
					className: "pb-3",
					children: /* @__PURE__ */ jsxs(CardTitle, {
						className: "flex items-center justify-between gap-3",
						children: [/* @__PURE__ */ jsx("span", { children: "Open Census profile" }), /* @__PURE__ */ jsx(Badge, {
							variant: "outline",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, {
					...
					className: "space-y-3",
					children: intel.demographicHighlights.map((signal) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between gap-2 text-sm",
						children: [/* @__PURE__ */ jsx("span", { children: signal.label }), /* @__PURE__ */ jsx("span", {
							className: "tabular text-primary",
					...
					className: "space-y-3",
					children: intel.marketSignals.map((signal) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between gap-2 text-sm",
						children: [/* @__PURE__ */ jsx("span", { children: signal.label }), /* @__PURE__ */ jsx("span", {
							className: "tabular text-primary",
							children: signal.value
			...
			/* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, {
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", { children: intel.trend }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: intel.dataGaps.map((gap) => /* @__PURE__ */ jsx("li", { children: gap }, gap))
						})]
					})
				]
			}) }),
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Mapped amenities" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("ul", {
				className: "space-y-2 text-sm",
				children: [intel.amenities.slice(0, 18).map((a) => /* @__PURE__ */ jsxs("li", {
				...
				}, a.id)), intel.amenities.length === 0 && /* @__PURE__ */ jsx("li", {
					className: "text-muted-foreground",
...
//#endregion
//#region src/lib/server/freekma-api.ts
var mapRequestSchema = z.object({
	lat: z.number().min(-90).max(90),
	lng: z.number().min(-180).max(180),
	radiusM: z.number().int().min(50).max(5e3),
...
//#endregion
//#region src/components/demographic-heatmap.tsx
function DemographicHeatmap() {
	...
	if (!selected) return /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Evidence map" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("p", {
		className: "text-sm text-muted-foreground",
	...
	return /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
		...
		children: [/* @__PURE__ */ jsx("span", { children: "Evidence map" }), intel && /* @__PURE__ */ jsxs(Badge, {
		...
		children: [
			...
			intel && /* @__PURE__ */ jsxs("div", {
				className: "space-y-3",
				children: [
					intel.checks.map((check) => /* @__PURE__ */ jsxs("div", {
						className: "rounded-lg border border-border bg-card p-3",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center justify-between gap-3",
							children: [/* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						}), run.modelRun ? /* @__PURE__ */ jsxs(Badge, {
							variant: "outline",
							children: [
					...
					run.providerNotice && /* @__PURE__ */ jsx("p", {
						className: "text-xs text-muted-foreground",
			...
			/* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsx(CardHeader, {
					...
					children: /* @__PURE__ */ jsxs(CardTitle, {
						...
						children: [/* @__PURE__ */ jsx(FileSearch, { className: "size-4" }), " Investment memo"]
					})
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, {
				...
				children: /* @__PURE__ */ jsxs(CardTitle, {
					className: "flex items-center gap-2 text-base",
					children: [/* @__PURE__ */ jsx(ShieldAlert, { className: "size-4" }), " Evidence gate"]
				})
			}), /* @__PURE__ */ jsx(CardContent, {
				className: "space-y-3",
				children: run.claims.map((claim) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, {
				...
				children: /* @__PURE__ */ jsxs(CardTitle, {
					className: "flex items-center gap-2 text-base",
					children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "size-4" }), " Risk register"]
				})
			}), /* @__PURE__ */ jsx(CardContent, {
				className: "space-y-3",
				children: run.risks.map((risk) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ jsx(Badge, {
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, {
				...
				children: /* @__PURE__ */ jsxs(CardTitle, {
					className: "flex items-center gap-2 text-base",
					children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-4" }), " Lowest-cost next checks"]
				})
			}), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("ol", {
				className: "space-y-2 text-sm text-muted-foreground",
				children: run.requests.map((request) => /* @__PURE__ */ jsx("li", { children: request }, request))
			}) })] }),
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, {
				className: "pb-3",
				children: /* @__PURE__ */ jsx(CardTitle, {
				...
				className: "space-y-2 text-xs text-muted-foreground",
				children: [run.sources.map((source) => /* @__PURE__ */ jsxs("p", { children: [
					/* @__PURE__ */ jsx("span", {
					...
					". ",
					source.detail
				] }, source.id)), missing.length > 0 && /* @__PURE__ */ jsxs("p", {
...
//#endregion
//#region src/components/property-map.tsx
var TILE_LAYERS = {
	dark: {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					geofenceMode && selected && /* @__PURE__ */ jsx("div", {
			...
			lastTwoPoints && /* @__PURE__ */ jsxs("div", {
...
function PropertyMap({ onMapClick }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "relative h-full w-full",
		children: [mapMode === "cesium" ? /* @__PURE__ */ jsx(CesiumPropertyMap, { onMapClick }) : /* @__PURE__ */ jsx(LeafletPropertyMap, { onMapClick }), /* @__PURE__ */ jsxs("div", {
...
function MapHost({ onMapClick }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(PropertyMap, { onMapClick }), !selected && /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/lib/server/diligence.ts
var createDiligenceRun = createServerFn({ method: "POST" }).validator((input) => ({
	dossier: z.custom().parse(input.dossier),
	neighborhood: z.custom().parse(input.neighborhood),
...
//#endregion
//#region src/components/scout-workspace.tsx
var STAGES = [
	"Geocoding parcel",
			...
			/* @__PURE__ */ jsxs("header", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(CommandSearch, { onSelect: onHit })
					}),
					/* @__PURE__ */ jsx("div", {
						className: "flex items-center gap-2",
						children: /* @__PURE__ */ jsx(GeofenceToggle, {})
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("section", {
					...
					children: [
						mapReady ? /* @__PURE__ */ jsx(MapHost, { onMapClick }) : /* @__PURE__ */ jsx("div", { className: "h-full bg-muted" }),
						geofenceMode && selected && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: "Geofence" }), /* @__PURE__ */ jsx("span", {
									className: "tabular",
						...
						dossierStatus === "loading" && /* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							className: "p-4",
							children: [
								panelTab === "dossier" && /* @__PURE__ */ jsx(DossierPanel, {
									dossier,
									loading: dossierStatus === "loading",
									neighborhood,
									onSample: onHit
								}),
								panelTab === "diligence" && /* @__PURE__ */ jsx(DiligencePanel, {
									run: diligence,
									loading: diligenceStatus === "loading"
								}),
								panelTab === "neighborhood" && /* @__PURE__ */ jsx(NeighborhoodPanel, {
									intel: neighborhood,
									loading: neighborhoodStatus === "loading"
								}),
								panelTab === "heatmap" && /* @__PURE__ */ jsx(DemographicHeatmap, {}),
								panelTab === "alter" && /* @__PURE__ */ jsx(AlterStudio, {}),
								panelTab === "campaign" && /* @__PURE__ */ jsx(CampaignPanel, {})
							]
						})
					})]
				})]
			}),
			history.length > 0 && /* @__PURE__ */ jsxs("footer", {
				className: "hidden shrink-0 items-center gap-2 overflow-x-auto border-t border-border px-4 py-2 md:flex",
				children: [/* @__PURE__ */ jsx("span", {
					className: "text-[11px] uppercase tracking-wider text-muted-foreground",
					children: "Recent"
				}), history.slice(0, 6).map((h) => /* @__PURE__ */ jsx(Button, {
					type: "button",
					size: "sm",
					variant: "ghost",
...
function Home() {
	return /* @__PURE__ */ jsx(ScoutWorkspace, {});
}
//#endregion
